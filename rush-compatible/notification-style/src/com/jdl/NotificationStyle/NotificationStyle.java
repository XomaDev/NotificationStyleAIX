...
public class NotificationStyle extends AndroidNonvisibleComponent implements OnDestroyListener {
  ...
  public void AskNotificationsPermission() {
    if (Build.VERSION.SDK_INT >= 33) {
      form.requestPermissions(
              new String[]{"android.permission.POST_NOTIFICATIONS"}, 7);
    }
  }

  @SimpleEvent(description = "When the user grants / denies notification permission")
  ...
  public boolean HasNotificationsPermission() {
    return ContextCompat.checkSelfPermission(form,
            "android.permission.POST_NOTIFICATIONS") != -1;
  }

  @SimpleProperty(description = "Set Icon notification.")
  ...
  @SimpleProperty(description = "Starting in Android 8.0 (API level 26), all notifications must be assigned to a channel.")
  ...
  @SimpleProperty(description = "Set priority channel.")
  ...
  @SimpleProperty(description = "Set priority notification.")
